...
const brandContent = `# GhostGauge — Brand Card (v1.1)
...
• **Proof points**:
  o Five-pillar model with published inputs & weights (35/25/20/10/10).
  o Winsorized z-scores → logistic 0–100; stale data auto-excluded with weight re-normalization.
  o Factor History CSVs updated daily; Provenance with source notes, schema tripwires, and fallbacks.
  o ETF Flows via robust parser (21-day sum) with staleness & outlier guards.
  o Optional small adjustments: cycle residual & spike detector—capped and disclosed.
  o Clear risk bands and plain-English playbook.
