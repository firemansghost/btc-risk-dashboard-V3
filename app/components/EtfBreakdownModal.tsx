...
export default function EtfBreakdownModal({ isOpen, onClose }: EtfBreakdownModalProps) {
  ...
  return (
    <div className="glass-modal-backdrop fixed inset-0 flex items-center justify-center z-50 p-4">
      <div className="glass-modal rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
