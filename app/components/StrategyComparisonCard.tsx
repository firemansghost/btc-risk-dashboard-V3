    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div className="px-6 py-4 border-b border-gray-200">
        <p className="text-xs text-gray-500 mb-2">
          Source: <code className="bg-gray-100 px-1 rounded">/data/dca_vs_risk_comparison.json</code> — published comparison snapshot (not generated by the weekly GitHub Action). Different window and methodology than <strong>Backtesting Status</strong> (<code className="text-[11px] bg-gray-100 px-1 rounded">weekly_backtesting_report.json</code>).
        </p>
