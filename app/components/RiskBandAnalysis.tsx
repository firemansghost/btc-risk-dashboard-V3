  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg p-8 text-white">
        <h2 className="text-2xl font-bold mb-4">🎯 Risk Band Effectiveness Analysis</h2>
        <p className="text-lg mb-6">
          Our risk bands are working as intended - buying signals show higher forward returns than selling signals.
        </p>
      ...
      <div className="bg-gradient-to-r from-green-600 to-blue-600 rounded-lg p-8 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h4 className="font-semibold mb-2">✅ Risk Bands Work as Intended</h4>
            <p className="text-sm opacity-90">
              Buying signals (Begin Scaling In) show the highest returns (9.18%) and win rates (69.6%), 
              validating our risk assessment methodology.
            </p>
          </div>
          <div>
            <h4 className="font-semibold mb-2">📈 Clear Performance Hierarchy</h4>
            <p className="text-sm opacity-90">
              Lower G-Scores consistently outperform higher G-Scores, confirming that 
              our risk bands effectively identify market opportunities.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="border border-gray-200 rounded-lg p-4">
            <h4 className="font-semibold text-green-800 mb-2">🟢 Begin Scaling In (G-Score < 50)</h4>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            <h4 className="font-semibold text-yellow-800 mb-2">🟡 Begin Scaling Out (G-Score > 70)</h4>
            <ul className="text-sm text-gray-700 space-y-1">
