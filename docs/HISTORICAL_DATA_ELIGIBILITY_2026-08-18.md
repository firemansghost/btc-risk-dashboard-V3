...
| Display / UI chart of current `history.csv` | — | Mixed file | Mixed | **YES** — H2.1 default is observed current-file history; mixed reconstruction is opt-in and marked | **NO** | **NO** | **NO** | **NO** | Current H2.1 UI is provenance-aware: observed current-file history is the default; legacy reconstruction is opt-in and separately marked at the Sep 26/27 boundary. Oct 7–28 remain current-file visual gaps; H3 Git recovery is for the future research manifest, not the production chart source |
