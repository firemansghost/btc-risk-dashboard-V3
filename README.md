[![Bundle Size](https://img.shields.io/badge/bundle%20size-3.48 MB-blue)](https://github.com/firemansghost/btc-risk-dashboard-V3/actions)
...
Active identifiers: **v1.1.2** / **etf-sosovalue-vix-cboe-2026-09** / SSOT **2.1.1**. Live ETF source: SoSoValue. Farside is the frozen historical calibration baseline. Macro uses FRED for dollar and rates, and direct Cboe official daily history for VIX, with a guarded FRED VIXCLS fallback.
